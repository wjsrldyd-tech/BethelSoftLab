...
(function () {
    ...
    const VIEWS = [
        {
            ...
            imageAspect: 1024 / 673,
            imageVersion: '20260715b',
            regions: ['동지중해', '흑해 인근', '이탈리아반도', '지중해'],
            ports: {
                오데사: { x: 70, y: 8 },
                타간로크: { x: 88, y: 7 },
                케르치: { x: 80, y: 14 },
        ...
        },
        {
            ...
            label: '북해·스칸디나비아',
            anchor: '암스테르담',
            image: 'images/origin/northsea.png',
            imageAspect: 1024 / 673,
            imageVersion: '20260715b',
            regions: ['북해', '스칸디나비아반도', '잉글랜드 서쪽'],
            ports: {
                런던: { x: 32, y: 58 },
                도버: { x: 38, y: 60 },
                칼레: { x: 42, y: 62 },
        ...
        },
        {
            ...
            label: '서아프리카',
            anchor: '엘미나',
            image: 'images/origin/wafrica.png',
            imageAspect: 1024 / 673,
            imageVersion: '20260715a',
            regions: ['서아프리카'],
            ports: {
                아르긴: { x: 28, y: 18 },
                배서스트: { x: 26, y: 28 },
        ...
        },
        {
            ...
            label: '동·남아프리카',
            anchor: '몸바사',
            image: 'images/origin/eafrica.png',
            imageAspect: 1024 / 673,
            imageVersion: '20260715a',
            regions: ['동아프리카', '남아프리카'],
            ports: {
        ...
        },
        {
            ...
            label: '남인도양',
            anchor: '무스카트',
            image: 'images/origin/southindian.png',
            imageAspect: 1024 / 673,
            imageVersion: '20260715a',
            regions: ['남인도양'],
            ports: {
        ...
        },
        {
            ...
            label: '동인도양',
            anchor: '캘리컷',
            image: 'images/origin/eastindian.png',
            imageAspect: 1024 / 673,
            imageVersion: '20260715a',
            regions: ['동인도양'],
            ports: {
        ...
        },
        {
            ...
            label: '동남아시아',
            anchor: '말라카',
            image: 'images/origin/seasia.png',
            imageAspect: 1024 / 673,
            imageVersion: '20260715a',
            regions: ['서남아시아', '동남아시아'],
            ports: {
        ...
        },
        {
            ...
            label: '동아시아',
            anchor: '한양',
            image: 'images/origin/eastasia.png',
            imageAspect: 1024 / 673,
            imageVersion: '20260715a',
            regions: ['동아시아', '극동서아시아', '극동남아시아', '동남아시아'],
            ports: {
                북경: { x: 42, y: 18 },
                서안: { x: 22, y: 32 },
                중경: { x: 28, y: 42 },
        ...
        },
        {
            ...
            label: '카리브·중미',
            anchor: '하바나',
            image: 'images/origin/caribbean.png',
            imageAspect: 1024 / 673,
            imageVersion: '20260715a',
            regions: ['중미', '북미'],
            ports: {
        ...
        },
        {
            ...
            label: '남미',
            anchor: '리우데자네이루',
            image: 'images/origin/southamerica.png',
            imageAspect: 1024 / 673,
            imageVersion: '20260715a',
            regions: ['남미', '남대서양'],
            ports: {
        ...
        },
        {
            ...
            label: '호주·태평양',
            anchor: '가리',
            image: 'images/origin/australia.png',
            imageAspect: 1024 / 673,
            imageVersion: '20260715a',
            regions: ['호주', '태평양'],
            ports: {
        ...
        },
        {
            ...
            label: '북미',
            anchor: '터코마',
            image: 'images/origin/northamerica.png',
            imageAspect: 1024 / 673,
            imageVersion: '20260715a',
            regions: ['북미', '동북미'],
            ports: {
        ...
        },
        {
            ...
            label: '북극해A',
            anchor: '나르비크',
            image: 'images/origin/arctic-a.png',
            imageAspect: 1024 / 673,
            imageVersion: '20260715a',
            regions: ['북극해A'],
            ports: {
        ...
        },
        {
            ...
            label: '북극해B',
            anchor: '오호츠크',
            image: 'images/origin/arctic-c.png',
            imageAspect: 1024 / 673,
            imageVersion: '20260715a',
            regions: ['북극해B'],
            ports: {
        ...
        },
        {
            ...
            label: '북극해C',
            anchor: '아르한겔스크',
            image: 'images/origin/arctic-mid.png',
            imageAspect: 1024 / 673,
            imageVersion: '20260715a',
            regions: ['북극해C'],
            ports: {
    ...
    const NEIGHBORS = {
        eastmed:       { up: 'northsea',    down: 'eafrica',      left: 'gibraltar',  right: 'southindian' },
        gibraltar:     { up: 'northsea',    down: 'wafrica',      left: 'caribbean',  right: 'eastmed' },
        northsea:      { up: 'arctic',      down: 'gibraltar',    left: 'northamerica', right: 'eastasia' },
        arctic:        { up: null,          down: 'northsea',     left: 'northamerica', right: 'arcticmid' },
        arcticmid:     { up: null,          down: 'northsea',     left: 'arctic',      right: 'arcticc' },
        arcticc:       { up: null,          down: 'eastasia',     left: 'arcticmid',   right: null },
        wafrica:       { up: 'gibraltar',   down: 'eafrica',      left: 'southamerica', right: 'eafrica' },
        eafrica:       { up: 'eastmed',     down: 'australia',    left: 'wafrica',    right: 'southindian' },
        southindian:   { up: 'eastasia',    down: 'australia',    left: 'eastmed',    right: 'eastindian' },
        eastindian:    { up: 'eastasia',    down: 'australia',    left: 'southindian', right: 'seasia' },
        seasia:        { up: 'eastasia',    down: 'australia',    left: 'eastindian', right: null },
        eastasia:      { up: 'arcticc',     down: 'seasia',       left: 'northsea',   right: null },
        ...
        northamerica:  { up: 'arctic',      down: 'caribbean',    left: null,         right: 'northsea' },
    };
