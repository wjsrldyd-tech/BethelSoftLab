...
(function () {
    ...
    function nestAction(a) {
        return {
            ...
            attack: {
                attackDistance: a.attackDistance ?? a.attackRange,
                minMonsters: a.minMonsters,
                attackRange: a.attackRange,
                moveType: a.moveType,
                moveMaxDistance: a.moveMaxDistance,
                moveMinDistance: a.moveMinDistance,
            },
            density: {
                densityType: a.densityType,
                distanceMin: a.distanceMin,
                distanceMax: a.distanceMax ?? a.densityRange,
                calcMinParam: a.calcMinParam,
                calcMaxParam: a.calcMaxParam,
                attackLimit: a.attackLimit,
                eliteWeight: a.eliteWeight,
                minionWeight: a.minionWeight,
                bigGuyWeight: a.bigGuyWeight,
                goblinWeight: a.goblinWeight,
                normalMonsterWeight: a.normalMonsterWeight,
    ...
    function flattenAction(a) {
        ...
        return {
            ...
            attackDistance: at.attackDistance ?? at.attackRange,
            minMonsters: at.minMonsters,
            attackRange: at.attackRange,
            densityType: d.densityType,
            distanceMin: d.distanceMin,
            distanceMax: d.distanceMax ?? d.densityRange,
            calcMinParam: d.calcMinParam,
            calcMaxParam: d.calcMaxParam,
            attackLimit: d.attackLimit,
            eliteWeight: d.eliteWeight,
            minionWeight: d.minionWeight,
            bigGuyWeight: d.bigGuyWeight,
            goblinWeight: d.goblinWeight,
            normalMonsterWeight: d.normalMonsterWeight,
            densityCount: d.densityCount,
            densityRange: d.densityRange,
            moveType: at.moveType,
            moveMaxDistance: at.moveMaxDistance,
            moveMinDistance: at.moveMinDistance,
        };
    }
